...
export async function resetDb() {
  ...
  // requestStatusHistory/requestReassignmentHistory também referenciam request com FK
  // RESTRICT (Task 3 passou a gravar linhas nelas) — precisam ser limpas antes de request.
